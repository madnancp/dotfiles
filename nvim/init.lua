...
vim.cmd("hi StatusLine guibg=none guifg=#ffffff") -- White text for active statusline
vim.cmd("hi StatusLineNC guibg=none guifg=#ffffff") -- White text for inactive statusline
